    ...
    <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-28">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          >
            Hi, I'm <span className="text-indigo-600">Suhas Y Gowda</span>
          </h1>
          <p 
            ref={descriptionRef}
        ...
        >
          <div className="w-full h-64 md:h-96 bg-indigo-100 dark:bg-indigo-900/30 rounded-xl overflow-hidden relative">
            ...
            {/* Replace with your actual photo */}
             <img src="https://dribbble.com/shots/1269168-Kick-Point-Default-Profile-Image" alt="Developer" className="w-full h-full object-cover" /> 
          </div>
          ...
          <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-4 bg-white dark:bg-gray-800 py-2 px-6 rounded-full shadow-lg">
            <a href="https://github.com/Suhasygowda" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
            ...
            <a href="https://www.linkedin.com/in/suhas-y-gowda-543a36275/" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="mailto:ssuhasygowda@gmail.com" className="text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
